...
/// <reference path="~/www/pages/exportcontrol/exportcontrolController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("exportcontrol");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new ExportControl.Controller(element);
            Log.ret(Log.l.trace);
        },

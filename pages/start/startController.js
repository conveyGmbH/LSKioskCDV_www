    ...
    WinJS.Namespace.define("Start", {
        Controller: WinJS.Class.derive(Application.Controller, function Controller(pageElement) {
            ...
            that.processAll().then(function () {
                ...
                Colors.loadSVGImageElements(pageElement, "start-navigate-image", 512, "#00417F", "title", function (svgInfo) {
                ...
                Colors.loadSVGImageElements(pageElement, "start-navigate-image-black", 512, "#00417F", "title", function (svgInfo) {
                });
